...
<div class="flex flex-col items-center justify-center mt-4 px-4">
    ...
    <div class="hidden flex rounded-lg shadow-2xl overflow-hidden flex-col items-center w-full mt-2 relative focus:outline-none transition ease-out duration-100" id="dropdown-menu">
        <div class="flex flex-col items-center w-full">
            <a href="{{ url("/1.x/setup") }}"
