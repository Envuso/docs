...
<div class="flex flex-col items-center justify-center mt-4 px-4">
    ...
    <button type="button"
        ...
        Version: <strong class="ml-1 text-purple-300">V1.X</strong>
    ...
    <div
        ...
        <div class="flex flex-col items-center w-full">
            <a href="{{ url("/v1/setup") }}"
               class=" py-2 font-medium transition flex flex-row items-center justify-center w-full bg-gray-700 text-white text-sm hover:bg-gray-900 hover:text-purple-400 hover:font-bold">V1.X</a>
            <a href="{{ url("/v2/setup") }}"
               class=" py-2 font-medium transition flex flex-row items-center justify-center w-full bg-gray-800 text-white text-sm hover:bg-gray-700 hover:text-purple-400 hover:font-bold">V2.X</a>
        </div>
    </div>
