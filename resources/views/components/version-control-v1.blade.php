...
<div class="text-left mt-2">
    <div>
        <button type="button" class="flex justify-center transition w-56 rounded-md shadow-sm px-4 py-2 bg-gray-900 text-sm font-medium text-purple-400 outline-none focus:outline-none dropdown-toggle">
            V1.X
